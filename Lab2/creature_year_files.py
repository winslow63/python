...
logging.basicConfig(filename='currency_log_creature_year_files.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler('currency_log_creature_year_files.log')
